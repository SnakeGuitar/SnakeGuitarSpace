            ...
            <div class="modal-content neu"
                ...
                <div :class="['modal-grid', isPortrait ? 'is-portrait' : 'is-landscape']">
                    ...
                    <div class="modal-right">
                        <h2 class="project-title" style="margin-bottom: 1rem">{{ project?.name ? $t(project?.name) : '' }}</h2>
                        <p class="project-desc" style="margin-bottom: 1.5rem">{{ project?.description ? $t(project?.description) : '' }}</p>
                        ...
                        <div class="tech-stacks" style="margin-bottom: 1.5rem;">
                            ...
                            <template v-else-if="project?.techStack">
                                <h4 style="margin-bottom: 0.5rem; color: var(--accent);">{{ $t('projects.tech_stack') }}</h4>
                                <div class="project-chips">
